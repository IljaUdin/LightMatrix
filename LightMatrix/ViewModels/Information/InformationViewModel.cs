...
namespace LightMatrix.ViewModels.Information
{
    public class InformationViewModel : ViewModelBase
    {
        ...
        public InformationViewModel(MainModel mainModel, TableConfiguration tableConfiguration, IPlayerService playerService)
        {
        ...
        public void TriggerOnTimedEvent()
        {
            ...
            {
                App.Current?.Services?.GetService<IPlayerService>()?.ReleaseCurrentMedia();
                CurrentViewModel = App.Current?.Services?.GetService<FuelViewModel>();
